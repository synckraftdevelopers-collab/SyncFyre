...
const reports = [
  ...
  ["Membership", "Subscription history", "/admin/reports/members", "memberships"],
  ["Trainers", "Trainer workload overview", "/admin/trainers", "trainers"],
  ["Monthly Joining", "New member trends", "/admin/reports/members", "monthly_joining"],
  ["Pending Payments", "Outstanding balances", "/admin/finance/outstanding", "pending_payments"],
  ["Subscriptions", "Plan subscription summary", "/admin/memberships", "subscriptions"],
] as const;
