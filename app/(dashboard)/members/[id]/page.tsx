...
export default async function MemberDetailPage({
  ...
  const canDelete = ["admin", "manager"].includes(profile.role?.slug ?? "");

  // Data needed for the edit form
    ...
    <div className="mx-auto max-w-4xl space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex gap-2">
          {canEdit && !isEditMode && (
            <Link href={`/members/${id}?edit=1`} className={buttonVariants({ variant: "outline", size: "sm" })}>
...
/** Lazily imported only when edit=1 to keep the server component light */
