...
export default async function OnboardingPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const tenantLoadFailed = Boolean(profile.tenant_id) && !tenant;
  ...
  return <main className="mx-auto max-w-5xl space-y-6 px-4 py-8 sm:px-6 lg:px-8">
    ...
    {tenant && <>
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <StepCard title="2. Main branch" description="Update branch details, GST, address, and contact information." href="/admin/settings?tab=application" complete={true} />
