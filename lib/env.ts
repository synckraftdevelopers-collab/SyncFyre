...
const optional = {
  ...
  BIOMETRIC_ADMS_SHARED_SECRET: process.env.BIOMETRIC_ADMS_SHARED_SECRET ?? "",
  BIOMETRIC_DIAGNOSTIC_MODE: process.env.BIOMETRIC_DIAGNOSTIC_MODE ?? "false",
} as const;
...
export const env = {
  ...
  BIOMETRIC_ADMS_SHARED_SECRET: string;
  BIOMETRIC_DIAGNOSTIC_MODE: string;
};
