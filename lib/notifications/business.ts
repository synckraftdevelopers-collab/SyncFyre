 ...
 *   - The notifications_business_type_check constraint in migrations 0023/0024/0057
 *   - The queue_branch_notification() and queue_business_notification() DB functions
 *   - The generate_membership_reminders(), generate_inactivity_alerts() and
 *     generate_low_pt_session_alerts() cron functions
 *
...
export const BUSINESS_NOTIFICATION_TYPES = [
  ...
  // ── Members ───────────────────────────────────────────────────────────────
  "member_created",
  // ── Smart alerts (13-Prompt Sprint — Prompts 12 & 13) ───────────────────────
