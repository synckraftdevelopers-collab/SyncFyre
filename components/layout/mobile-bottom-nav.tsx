...
export function MobileBottomNav({ portal, userRole, onMore, visibleNavHrefs }: { portal: PortalKey; userRole?: UserRole | null; onMore: () => void; visibleNavHrefs?: string[] | null }) {
