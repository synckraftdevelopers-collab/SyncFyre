...
export function CreateGymAdminForm() {
  ...
  return <form action={action} className="grid gap-4 md:grid-cols-2">
    ...
    <div className="md:col-span-2 text-xs text-muted-foreground">This creates the gym tenant, its main branch, the owner account, an Essential plan activation, and onboarding progress.</div>
