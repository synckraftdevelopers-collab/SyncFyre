          ...
          <div className="p-1.5 space-y-0.5">
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted-foreground">Opens a prepared message; it is not delivered yet</p>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center p-4">
          ...
          <div className="relative z-10 w-full max-w-md rounded-2xl border bg-background shadow-2xl overflow-hidden">
            ...
            <div className="p-4">
              ...
              />
              <p className="mt-1.5 text-xs text-muted-foreground">You can edit the message before opening WhatsApp or SMS. Opening an app does not confirm delivery.</p>
            </div>
