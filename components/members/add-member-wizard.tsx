...
export function AddMemberWizard({ branches, plans, trainers, basePath = "/admin/members", initialBranchId = null }: AddMemberWizardProps) {
  ...
  async function goNext() {
    ...
    if (step === 5 && paymentInvalid) { form.setError("payment_amount", { message: "Payment completed cannot be greater than total amount." }); return; }
