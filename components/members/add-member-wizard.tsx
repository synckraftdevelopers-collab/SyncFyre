...
export function AddMemberWizard({ branches, plans, trainers, basePath = "/admin/members", initialBranchId = null }: AddMemberWizardProps) {
  ...
  const form = useForm<WizardFormData>({ resolver: zodResolver(fullSchema), defaultValues: { status: "active", branch_id: initialBranchId ?? "", payment_method: "cash", start_date: getLocalDateInputValue() }, mode: "onTouched" });
